...
get_creditor_view_bac_a_sable <- function(ref_date = "", ra = "", oa = "")
{
    set_sgbd("HIVE")
    ...
    T2   <- get_bac_a_sable_t2(ref_date, ra, oa)
    T3   <- get_bac_a_sable_t3(ref_date, ra, oa)
    T6   <- get_bac_a_sable_t6("", ra, oa)
    T4C  <- get_bac_a_sable_t4(ref_date, ra, oa)
    T4D  <- get_bac_a_sable_t4(ref_date, ra, oa)
    T5   <- get_bac_a_sable_t5(ref_date, ra, oa)
    T1   <- get_bac_a_sable_golden_record_t1()
    T9   <- get_bac_a_sable_t9(ref_date, ra, oa)
    T10  <- get_bac_a_sable_t10(ref_date, ra, oa)
    ...
    compute_pge_bac_a_sable(table, ref_date, ra, oa)
...
compute_pge_bac_a_sable <- function(table, ref_date, ra, oa)
{
    T7 <- get_bac_a_sable_t7(ref_date, ra, oa)$
        select("ref_date", "ra", "oa", "prtctn_id", "prtctn_prvdr_cd")
    
    T8 <- get_bac_a_sable_t8(ref_date, ra, oa)$
